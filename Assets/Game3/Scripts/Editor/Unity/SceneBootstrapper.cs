...
namespace UnityEditorExtension
{
    ...
    public class SceneBootstrapper
    {
        ...
        const string k_LoadBootstrapSceneOnPlay = "Editor/Load Bootstrap Scene On Play";
        const string k_DoNotLoadBootstrapSceneOnPlay = "Editor/Don't Load Bootstrap Scene On Play";
