...
namespace FrostweepGames.VoicePro.Examples
{
    public class VCP_DemoUI : MonoBehaviour
    {
        ...
        public Enumerators.NetworkType networkType = Enumerators.NetworkType.PUN2;
        ...
        private void Start()
        {
            ...
            NetworkRouter.Instance.Register(rand, "Speaker" + rand, networkType); // network registrator
        }
